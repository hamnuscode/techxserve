...
const services = [
  ...
  },
  {
    ...
    desc: "Your data is one of your most valuable assets — if you know how to use it. We build AI-powered tools and data pipelines that transform raw numbers into real insight, helping you make sharper decisions and stay ahead of the curve.",
    included: [
